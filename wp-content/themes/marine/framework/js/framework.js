...
jQuery(document).ready(function($) {
	...
	$("#update-nav-menu").on("click", ".edit-menu-button-icon", function(event) {
		...
		tb_show("Shortcodes", popupurl + "?custom_popup_items=1&shortcode=custom_icon&width=750&pb_item_id=" + $nav_item_id + '&builder=edit-menu-item-icon&callback=insert_nav_icon');
	});
