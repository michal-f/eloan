    ...
    $aHelp = array(
        ...
        */
        ...
        array(
            ...
            'code' => '[content_box url="{url}" target="{target}" title="{title}" icon="{icon}" icon_color="{iconColor}" icon_bg="{iconBg}" title_color="{titleColor}" text_color="{textColor}" style="{style}"]{content}[/content_box]',
            'fields' => array(
                'style' => array(
                    'label' => __('Style', 'framework'),
                    'desc' => '',
