                        ...
                        <td>
							...
							if (!empty($this -> Slide() -> data -> type) && $this -> Slide() -> data -> type == "file") {
								if (!empty($this -> Slide() -> data -> image)) {									
                                    ...
                                    <p><a title="<?php echo esc_attr($this -> Slide() -> data -> title); ?>" class="colorbox" href="<?php echo $this -> Slide() -> data -> image_path; ?>"><img src="<?php echo $this -> Html -> bfithumb_image_src($this -> Slide() -> data -> image_path, 100, 100, 100); ?>" alt="" class="slideshow" /></a></p>
